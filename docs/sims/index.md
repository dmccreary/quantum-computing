---
title: List of MicroSims for Quantum Computing
description: A list of all 51 interactive MicroSims used in A Skeptic's Guide to Quantum Computing
...
This textbook includes **51 interactive MicroSims** — browser-based simulations
that let you explore quantum computing concepts, investment dynamics, cognitive
biases, and critical thinking frameworks hands-on. No installation required.

<div class="grid cards" markdown>

-   **[Bias Compounding Cascade](./bias-compounding-cascade/index.md)**

    ![Bias Compounding Cascade](./bias-compounding-cascade/bias-compounding-cascade.png)
...
-   **[Bias Detection Checklist](./bias-detection-checklist/index.md)**

    ![Bias Detection Checklist](./bias-detection-checklist/bias-detection-checklist.png)
...
-   **[Breakthrough Dependencies Map](./breakthrough-dependencies/index.md)**

    ![Breakthrough Dependencies Map](./breakthrough-dependencies/breakthrough-dependencies.png)
...
-   **[Classical vs. Quantum Error Rate Comparison](./error-rate-comparison/index.md)**

    ![Classical vs. Quantum Error Rate Comparison](./error-rate-comparison/error-rate-comparison.png)
...
-   **[Classical vs. Quantum Improvement Trajectories](./improvement-trajectories/index.md)**

    ![Classical vs. Quantum Improvement Trajectories](./improvement-trajectories/improvement-trajectories.png)
...
-   **[Cognitive Bias Network](./cognitive-bias-network/index.md)**

    ![Cognitive Bias Network](./cognitive-bias-network/cognitive-bias-network.png)
...
-   **[Complete QC Feedback Loop System](./qc-feedback-loop-system/index.md)**

    ![Complete QC Feedback Loop System](./qc-feedback-loop-system/qc-feedback-loop-system.png)
...
-   **[Computational Complexity Landscape](./complexity-landscape/index.md)**

    ![Computational Complexity Landscape](./complexity-landscape/complexity-landscape.png)
...
-   **[Cryptographic Vulnerability Window](./vulnerability-window/index.md)**

    ![Cryptographic Vulnerability Window](./vulnerability-window/vulnerability-window.png)
...
-   **[Error Rate Gap: Quantum vs. Classical](./error-rate-gap/index.md)**

    ![Error Rate Gap: Quantum vs. Classical](./error-rate-gap/error-rate-gap.png)
...
-   **[Ethical Decision Framework](./ethical-decision-framework/index.md)**

    ![Ethical Decision Framework](./ethical-decision-framework/ethical-decision-framework.png)
...
-   **[GPT Qualification Scorecard](./gpt-scorecard/index.md)**

    ![GPT Qualification Scorecard](./gpt-scorecard/gpt-scorecard.png)
...
-   **[Hardware Platform Radar Chart](./platform-comparison-radar/index.md)**

    ![Hardware Platform Radar Chart](./platform-comparison-radar/platform-comparison-radar.png)
...
-   **[Hype Detection Checklist](./hype-detection-tool/index.md)**

    ![Hype Detection Checklist](./hype-detection-tool/hype-detection-tool.png)
...
-   **[Hype Parallels](./hype-parallels/index.md)**

    ![Hype Parallels](./hype-parallels/hype-parallels.png)
...
-   **[Hype Reinforcement Loop](./hype-reinforcement-loop/index.md)**

    ![Hype Reinforcement Loop](./hype-reinforcement-loop/hype-reinforcement-loop.png)
...
-   **[Incentive Asymmetry Map](./incentive-asymmetry-map/index.md)**

    ![Incentive Asymmetry Map](./incentive-asymmetry-map/incentive-asymmetry-map.png)
...
-   **[Joint Probability Calculator](./joint-probability-calculator/index.md)**

    ![Joint Probability Calculator](./joint-probability-calculator/joint-probability-calculator.png)
...
-   **[Leverage Point Explorer](./leverage-point-explorer/index.md)**

    ![Leverage Point Explorer](./leverage-point-explorer/leverage-point-explorer.png)
...
-   **[Physics Bet Timeline](./physics-bet-timeline/index.md)**

    ![Physics Bet Timeline](./physics-bet-timeline/physics-bet-timeline.png)
...
-   **[Prediction Track Record Timeline](./qc-prediction-tracker/index.md)**

    ![Prediction Track Record Timeline](./qc-prediction-tracker/qc-prediction-tracker.png)
...
-   **[Probability Waterfall](./probability-waterfall/index.md)**

    ![Probability Waterfall](./probability-waterfall/probability-waterfall.png)
...
-   **[QC Application Landscape](./qc-application-landscape/index.md)**

    ![QC Application Landscape](./qc-application-landscape/qc-application-landscape.png)
...
-   **[QC Company Valuations vs. Revenue](./qc-valuation-scatter/index.md)**

    ![QC Company Valuations vs. Revenue](./qc-valuation-scatter/qc-valuation-scatter.png)
...
-   **[QC Investment Decision Tree](./qc-investment-decision-tree/index.md)**

    ![QC Investment Decision Tree](./qc-investment-decision-tree/qc-investment-decision-tree.png)
...
-   **[QC Investment Expected Value Calculator](./qc-expected-value-calculator/index.md)**

    ![QC Investment Expected Value Calculator](./qc-expected-value-calculator/qc-expected-value-calculator.png)
...
-   **[QC Investment Flow](./qc-investment-flow/index.md)**

    ![QC Investment Flow](./qc-investment-flow/qc-investment-flow.png)
...
-   **[QC Investment vs. Revenue](./qc-investment-vs-revenue/index.md)**

    ![QC Investment vs. Revenue](./qc-investment-vs-revenue/qc-investment-vs-revenue.png)
...
-   **[Quantum Computing History Timeline](./qc-history-timeline/index.md)**

    ![Quantum Computing History Timeline](./qc-history-timeline/qc-history-timeline.png)
...
-   **[Quantum Portfolio Explorer](./quantum-portfolio-explorer/index.md)**

    ![Quantum Portfolio Explorer](./quantum-portfolio-explorer/quantum-portfolio-explorer.png)
...
-   **[Qubit Scaling vs. Cryptographic Requirements](./qubit-scaling-vs-crypto/index.md)**

    ![Qubit Scaling vs. Cryptographic Requirements](./qubit-scaling-vs-crypto/qubit-scaling-vs-crypto.png)
...
-   **[Qubit State on the Bloch Sphere](./bloch-sphere/index.md)**

    ![Qubit State on the Bloch Sphere](./bloch-sphere/bloch-sphere.png)
...
-   **[Rhetorical Patterns in QC Advocacy](./rhetorical-patterns/index.md)**

    ![Rhetorical Patterns in QC Advocacy](./rhetorical-patterns/rhetorical-patterns.png)
...
-   **[Risk-Return Scatter Plot](./quantum-risk-return-scatter/index.md)**

    ![Risk-Return Scatter Plot](./quantum-risk-return-scatter/quantum-risk-return-scatter.png)
...
-   **[Shor's Algorithm: Resource Requirements](./shors-algorithm-resources/index.md)**

    ![Shor's Algorithm: Resource Requirements](./shors-algorithm-resources/shors-algorithm-resources.png)
...
-   **[Skeptical Inquiry Flowchart](./skeptical-inquiry-flowchart/index.md)**

    ![Skeptical Inquiry Flowchart](./skeptical-inquiry-flowchart/skeptical-inquiry-flowchart.png)
...
-   **[Success vs. Failure Patterns](./success-failure-patterns/index.md)**

    ![Success vs. Failure Patterns](./success-failure-patterns/success-failure-patterns.png)
...
-   **[TCO Comparison Dashboard](./tco-comparison-dashboard/index.md)**

    ![TCO Comparison Dashboard](./tco-comparison-dashboard/tco-comparison-dashboard.png)
...
-   **[Technology Bet Decision Framework](./tech-bet-decision-framework/index.md)**

    ![Technology Bet Decision Framework](./tech-bet-decision-framework/tech-bet-decision-framework.png)
...
-   **[Technology Bubble Dynamics](./tech-bubble-dynamics/index.md)**

    ![Technology Bubble Dynamics](./tech-bubble-dynamics/tech-bubble-dynamics.png)
...
-   **[Technology Success Indicator Analysis](./tech-success-analyzer/index.md)**

    ![Technology Success Indicator Analysis](./tech-success-analyzer/tech-success-analyzer.png)
...
-   **[The Advantage Gap](./advantage-gap/index.md)**

    ![The Advantage Gap](./advantage-gap/advantage-gap.png)
...
-   **[The Barrier Stack](./barrier-stack/index.md)**

    ![The Barrier Stack](./barrier-stack/barrier-stack.png)
...
-   **[The Hype Amplification Pipeline](./hype-amplification-pipeline/index.md)**

    ![The Hype Amplification Pipeline](./hype-amplification-pipeline/hype-amplification-pipeline.png)
...
-   **[The Hype Ecosystem](./hype-ecosystem/index.md)**

    ![The Hype Ecosystem](./hype-ecosystem/hype-ecosystem.png)
...
-   **[The Perpetual "5-10 Years Away" Pattern](./prediction-pattern/index.md)**

    ![The Perpetual "5-10 Years Away" Pattern](./prediction-pattern/prediction-pattern.png)
...
-   **[The Shrinking 'Supremacy' Gap](./supremacy-gap-timeline/index.md)**

    ![The Shrinking 'Supremacy' Gap](./supremacy-gap-timeline/supremacy-gap-timeline.png)
...
-   **[TRL Assessment Tool](./trl-assessment-tool/index.md)**

    ![TRL Assessment Tool](./trl-assessment-tool/trl-assessment-tool.png)
...
-   **[VC Portfolio Simulator: QC vs. Classical](./vc-portfolio-simulator/index.md)**

    ![VC Portfolio Simulator: QC vs. Classical](./vc-portfolio-simulator/vc-portfolio-simulator.png)
...
-   **[Workload Distribution](./workload-distribution/index.md)**

    ![Workload Distribution](./workload-distribution/workload-distribution.png)
